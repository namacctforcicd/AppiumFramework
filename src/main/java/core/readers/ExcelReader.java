...
public class ExcelReader {
    ...
    private static String EXCEL_FILE_PATH = System.getProperty("user.dir") + File.separator + "exceltestdata" + File.separator + "credentials.xlsx";
    ...
    public static void main(String[] args) {
        ...
        ExcelReader.getDataFromSheetName("MindMajix");
    }
