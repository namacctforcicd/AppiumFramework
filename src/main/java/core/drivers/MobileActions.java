...
public class MobileActions {
    ...
    public static String takeScreenShot() {
        String currentTimeStamp = new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss").format(new Date());
        String SCREENSHOTS_PATH = System.getProperty("user.dir") + File.separator + "output" + File.separator + "reports"+ File.separator + "screenshots" + File.separator +currentTimeStamp + ".png";
